            ...
            <div className='w-[80%] mx-auto grid grid-cols-1 lg:grid-cols-5 gap-10 items-center'>
                ...
                <div className='lg:col-span-2'>
                    ...
                    <p className='mt-4 text-gray-700'>
                        Our team is a dynamic group of skilled professionals passionate about innovation, collaboration, and delivering high-quality solutions. We thrive on creativity and technical excellence to bring ideas to life.
                    </p>
                    {/* button */}
                    <div className='mt-8'>
