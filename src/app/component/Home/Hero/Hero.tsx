...
const Hero = () => {
    return (
        <div className='relative w-full h-[110vh] sm:h-screen bg-[url(/images/bg.png)] 
        bg-cover bg-center flex justify-center flex-col'>

            <div className='w-[90%] md:w-[80%] mx-auto items-center grid grid-cols-1 xl:grid-cols-2 gap-10'>
                {/* text center */}
                <div data-aos="fade-up" >
                    <p className='text-sm sm:text-base md:text-lg font-bold text-blue-950'>
                        Make the best Investment
                    </p>
                    <h1 className='text-2xl md:text-3xl lg:text-4xl mt-6
                mb-6 font-bold text-blue-950 leading-[2.5rem] md:leading-[3.5rem]'>
                    ...
                    <p className='text-xs sm:text-sm md:text-base font-medium text-gray-700'>
                        Investment is the act of putting money into assets like stocks,
                        real estate, or businesses to generate future returns.
                        It involves risk, but with careful planning,
                        it can help build wealth over time.
                    </p>
                    {/* Rating */}
                        ...
                        <div className='flex items-center space-x-4'>
                            ...
                            <div>
                                <div className='flex items-center space-x-2'>
                                    <h1 className='text-lg sm:text-xl m:text-2xl text-gray-700 font-bold'>
                                        4.5</h1>
                                ...
                                <p className='text-gray-700 text-sm sm:text-base'>Best Rate On Google</p>
                            </div>
                        </div>
                        <div className='flex mt-6  sm:mt-0 items-center space-x-4'>
                            <Image src={linked} alt='LinkedIn' width={40} height={40} />
                            <div>
                                <div className='flex items-center space-x-2'>
                                    <h1 className='text-lg sm:text-xl m:text-2xl text-gray-700 font-bold'>
                                        4.7</h1>
                                ...
                                <p className='text-gray-700 text-sm sm:text-base'>Best Rate On LinkedIn</p>
                            </div>
                        </div>
                    </div>
                    {/* button section */}
